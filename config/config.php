<?php
	...
	// Last Updated: 2nd Dec 2013 @ 1:09 PM

	$GLOBALS['ISC_CFG']["isSetup"] = true;
	$GLOBALS['ISC_CFG']["Language"] = 'en';
	$GLOBALS['ISC_CFG']["AllowPurchasing"] = 1;
	$GLOBALS['ISC_CFG']["serverStamp"] = 'ISCEAgAAAAAAAAAAIIQc1MxvR2kSb61voTYAsQ=';
	...
	$GLOBALS['ISC_CFG']["dbUser"] = 'raf1qu3_maha';
	$GLOBALS['ISC_CFG']["dbPass"] = 'padgptd';
	$GLOBALS['ISC_CFG']["dbDatabase"] = 'raf1qu3_maha';
	$GLOBALS['ISC_CFG']["tablePrefix"] = 'shop_';
	$GLOBALS['ISC_CFG']["StoreName"] = 'MAHA London';
	$GLOBALS['ISC_CFG']["StoreAddress"] = '38 Shoebury Rd,
London,
E6 2AQ';
	...
	$GLOBALS['ISC_CFG']["MetaKeywords"] = 'MAHA, Luxury, Perfume, Fragrance, calogne';
	$GLOBALS['ISC_CFG']["MetaDesc"] = 'Shop MAHA London\'s Official site. Discover luxury fragrances, the latest collection of women\'s fashion, accessories and mens clothing, inspired by the middle-east.  ';
	...
	$GLOBALS['ISC_CFG']["InstallDate"] = 1385949314;
	...
	$GLOBALS['ISC_CFG']["AdminEmail"] = 'info@mrgeekee.com';
	$GLOBALS['ISC_CFG']["OrderEmail"] = 'info@mrgeekee.com';
