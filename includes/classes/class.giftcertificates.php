	...
	private function PurchaseGiftCertificate($errors = array())
	{
		...
		foreach($enabledThemes as $theme) {
			...
			if(in_array($theme, $themes)) {
				...
				$GLOBALS['GiftCertificateThemes'] .= sprintf('<input type="radio" id="' . $theme . '" class="themeCheck" name="certificate_theme" value="%s" %s /><label for="' . $theme . '"><span></span> %s</label><br />', $theme, $sel, $themeName);
			}
		}
